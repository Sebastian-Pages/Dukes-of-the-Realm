...
public class Main extends Application {
    ...
    public void creaneedsAIGoalatusBar() {
        statusBar = new HBox();
    ...
    private void sendOst(Castle c, Castle d) {
        ...
        for (Unit u : o.reserve) {
            ...
            System.out.println("DEBUG: d.getCenterX() = " + d.getCenterX());
            System.out.println("DEBUG: d.getCenterX() = " + d.getCenterX());
            System.out.println("DEBUG: o.getReserveSize()) = " + o.getReserveSize());
            u.setGoalx(d.getCenterX());
            u.setGoaly(d.getCenterY());
            units.add(u);
